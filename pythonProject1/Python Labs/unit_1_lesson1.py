...
#### a syntax error here! there was no close ")" on the print function #####
#### another error here is "users" instead of "user" ####
    if user == computer:
    ...
    # check all cases if user is rock
        ...
        # check losing case
#### wrong losing case presented here, this would be a tie. changed from "rock" to "paper" ####
        elif computer == "rock":
    ...
    # check all cases if user is paper
        ...
        # check winning case
####   Invalid syntax here! after rock a ":" was needed. ####
        if computer == "rock":
            print("You win!")
...
#### print command here is capitalized. ####
            print("Sorry, You lose.")
